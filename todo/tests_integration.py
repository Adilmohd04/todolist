...
class TaskIntegrationTests(APITestCase):
    ...
    def test_create_task_success(self):
        ...
        response = self.client.post(self.url, data, format='json', HTTP_AUTHORIZATION=f'Basic {self.auth_encoded}')
    ...
    def test_update_task_success(self):
        ...
        response = self.client.put(url, data, HTTP_AUTHORIZATION=f'Basic {self.auth_encoded}')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_delete_task_success(self):
        ...
        url = f'/tasks/{task.pk}/'
        response = self.client.delete(url, HTTP_AUTHORIZATION=f'Basic {self.auth_encoded}')
    ...
    def test_authentication_failed(self):
        ...
        invalid_auth_encoded = base64.b64encode(invalid_auth.encode('utf-8')).decode('utf-8')
        data = {"title": "Test Task", "description": "Test description"}
        response = self.client.post(self.url, data, format='json', HTTP_AUTHORIZATION=f'Basic {invalid_auth_encoded}')
